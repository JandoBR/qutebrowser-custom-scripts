...
if not is_daemon_alive():
    # Remove stale files so the new daemon doesn't get confused
    ...
    if os.path.exists(daemon_path):
        # We start it as a child process.
        # The daemon itself will handle the 'kill when browser closes' logic.
        subprocess.Popen(['python3', daemon_path], env=os.environ)
